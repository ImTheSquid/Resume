...
\begin{paracol}{2} % Begin two-column mode
	...
	{Leading a team working to create a fault-tolerant and compact system to activate rocketry systems while collecting data for avionics missions with \textbf{Rust}.} % Description
